...
<body>
	<main class="container text-center">
		...
		<form:form class="row mt-5" action="/mail/send-mutiple-mail" method="post" modelAttribute="mail">
			...
			<div class="col-12 text-center">
				...
				<form:button formaction="/mail/store-mail" class="btn btn-warning">ADD MAIL</form:button>
			</div>
		</form:form>
	</main>
</body>
